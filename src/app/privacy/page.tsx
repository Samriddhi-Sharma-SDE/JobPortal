    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-secondary/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="prose prose-lg max-w-4xl mx-auto bg-card p-8 rounded-lg shadow-sm">
            ...
            <p>Welcome to JobLink Local. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us.</p>
            ...
            <p>If you have questions or comments about this policy, you may email us at <a href="mailto:privacy@joblink.local">privacy@joblink.local</a> or by post to:</p>
            <address>
                JobLink Local, Inc.<br />
